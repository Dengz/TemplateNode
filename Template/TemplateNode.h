...
//const YGAlign YGAlignFromString(const char* value);
//const YGDimension YGDimensionFromString(const char *value);
//const YGDirection YGDirectionFromString(const char *value);
//const YGDisplay YGDisplayFromString(const char *value);
//const YGEdge YGEdgeFromString(const char *value);
//const YGFlexDirection YGFlexDirectionFromString(const char *value);
//const YGJustify YGJustifyFromString(const char *value);
//const YGMeasureMode YGMeasureModeFromString(const char *value);
//const YGNodeType YGNodeTypeFromString(const char *value);
//const YGOverflow YGOverflowFromString(const char *value);
//const YGPositionType YGPositionTypeFromString(const char *value);
//const YGUnit YGUnitFromString(const char *value);
//const YGWrap YGWrapFromString(const char *value);

@interface TemplateNode : NSObject
...
/**
 Return the attaching UIView. If current node is a virtual node, then the attaching view is nil.
 */
@property (nonatomic, readwrite, strong) UIView *view;

@property (nonatomic, readwrite, strong) CALayer *layer;

/**
 Initializer with attaching view.
 */
- (instancetype)initWithView:(UIView*)view;

/**
 Initializer with view class, style and view configs.
 */
